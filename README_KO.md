...
**현재 버전: v0.9.0 — Catalyst & Event Intelligence**

v0.9.0은 공식 출처 기반 촉매 및 이벤트 인텔리전스, 주요 이벤트
타임라인, 투자 논리 영향 매핑, 확인된 예정 촉매, 스냅샷 기준 이벤트
필터링을 추가하면서 투자 논리 추적, 동종기업 리서치, 가치평가 지능,
공식 실적 근거를 유지합니다.
