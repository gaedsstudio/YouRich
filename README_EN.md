...
| Risk | Financial quality and quantitative risk checks |
...
Qualitative risks are handled by the host agent using public evidence and kept separate from deterministic results.
...
3. Normalize periods and fields
4. Check missing data and data quality
5. Research business fundamentals when needed
6. Run deterministic valuation
7. Run financial-quality checks
8. Run quantitative risk checks
9. Verify important claims with evidence
10. Build bull case
11. Build bear case
12. Produce investment thesis
```
